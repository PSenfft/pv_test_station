/****************************************************************************************************************************
  ...
  For SAMD boards
  Written by Khoi Hoang edited by P.Senfft
...
#define TIMER_INTERVAL_MS        700 // 700 ms time to wake up temp sensor

#define TIMER_DURATION_MS        1000 //1s measure loop
...
extern volatile uint32_t preMillisTimer;
